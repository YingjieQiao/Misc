...
def algorithm3(problem, bestSeen = None, trace = None):
    ...
    subproblems.append((subStartR1, subStartC1, subNumR1, subNumC1)) #2
    subproblems.append((subStartR1, subStartC2, subNumR1, subNumC2)) #1
    subproblems.append((subStartR2, subStartC1, subNumR2, subNumC1)) #3
    subproblems.append((subStartR2, subStartC2, subNumR2, subNumC2)) #4
    ...
    ###Does this line indicates that, if there is no better neighbour, neighbour = crossLoc?###
